...
##### 3.2.12 Visualizing the output in **tmap**
...
![](images/L-function)1.2%20for%20non-02.png){width="536"}
...
![]()![](images/HYPOFOR%20FUNCTIION%20_GRAPH2-03.png)

```{r}
#plot(L_ck.csr, . - r ~ r, xlab="d", ylab="L(d)-r")
```

![](images/HYPOFOR%20FUNCTIION%20_GRAPH2-01.png)
...
In the code chunk below local_colocation() us used to compute the LCLQ values for each NonFunctional water point event.
